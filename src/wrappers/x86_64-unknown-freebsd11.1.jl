# Autogenerated wrapper script for libsndfile_jll for x86_64-unknown-freebsd11.1
...
const libsndfile_splitpath = ["lib", "libsndfile.so"]
...
const libsndfile = "libsndfile.so.1"
