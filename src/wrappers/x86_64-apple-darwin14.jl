# Autogenerated wrapper script for libsndfile_jll for x86_64-apple-darwin14
...
const sndfile_cmp_splitpath = ["bin", "sndfile-cmp"]
...
const sndfile_convert_splitpath = ["bin", "sndfile-convert"]
...
const libsndfile_splitpath = ["lib", "libsndfile.1.dylib"]
...
const libsndfile = "@rpath/libsndfile.1.dylib"


# Relative path to `sndfile_play`
const sndfile_play_splitpath = ["bin", "sndfile-play"]
...
const sndfile_interleave_splitpath = ["bin", "sndfile-interleave"]
...
const sndfile_concat_splitpath = ["bin", "sndfile-concat"]
...
const sndfile_metadata_set_splitpath = ["bin", "sndfile-metadata-set"]
...
const sndfile_metadata_get_splitpath = ["bin", "sndfile-metadata-get"]
...
const sndfile_salvage_splitpath = ["bin", "sndfile-salvage"]
...
const sndfile_info_splitpath = ["bin", "sndfile-info"]
...
const sndfile_deinterleave_splitpath = ["bin", "sndfile-deinterleave"]
